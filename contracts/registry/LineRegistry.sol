...
contract LineRegistry is ILineRegistry, AccessControl {
  ...
  constructor(
    IServiceProviderRegistry registry,
    uint256 _selfRegister
  ) {
  ...
  /// @inheritdoc ILineRegistry
  function file(bytes32 what, bytes32 line, address data) external auth {
  ...
  /// @inheritdoc ILineRegistry
  function file(bytes32 what, bytes32 line, uint256 data) external auth {
